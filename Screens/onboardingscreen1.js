...
export default function OnboardingScreen({ navigation }) {
  ...
  const handleSkip = () => {
    navigation.navigate('OnboardingScreen2'); // Replace 'NextScreen' with the actual next screen
  };

  const handlePress = () => {
    setProgress( 0.33); // Adjust progress as necessary
    setTimeout(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image style={styles.image} source={require('../assets/Anywhere-you-are.png')} />
      <Text style={styles.title}>Anywhere you are</Text>
      <Text style={styles.subtitle}>Not sure where to catch your local transport vehicle?</Text>
